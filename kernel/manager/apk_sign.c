...
static apk_sign_key_t apk_sign_keys[] = {
    ...
    [KSU_SIGNATURE_INDEX_KSUNEXT] = { EXPECTED_SIZE_KSUNEXT, EXPECTED_HASH_KSUNEXT }, // KernelSU-Next/KernelSU-Next
    { EXPECTED_SIZE_WILDKSU, EXPECTED_HASH_WILDKSU }, // WildKernels/Wild_KSU
#ifdef EXPECTED_SIZE
